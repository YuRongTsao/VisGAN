...
function sheetContainer(curr_dataset,curr_sheet_num){
    ...
    setAttributes(explore_view,{id:explore_view_id,
                                style:"overflow: auto;height:"+exploration_view_height+
    ...
    sheet_container.appendChild(explore_view)    
...
function extraContent(canvas_id){
    ...
    setAttributes(extra_content,{class:"extra content",style:"padding-left:8px;padding-right:8px;padding-top:8px;padding-bottom:5px"})
...
function legendDiv(chart_data){
    ...
    setAttributes(legend,{class:"legend",style:"text-align: left;padding-left:8px;padding-bottom:5px;border-top: 1px solid #ECECEC;"})
    ...
    chart_data.datas.forEach(function(item,i){
        ...
        if(chart_data.type!="doughnut"){
            ...
            if(chart_data.datas.length>1){
                var text = document.createElement("div")
                setAttributes(text,{style:"display:inline-block;margin-left:3px;color:#707070;font-size:9pt"})
                text.innerHTML = (i == 0)? "Outer: " + item.label : "Inner: Overall"
